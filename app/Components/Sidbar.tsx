...
function Sidbar() {
  ...
  return (
    <aside className="fixed overflow-y-auto top-18 left-0 w-64 h-screen pt-2 transition-transform bg-white border-r border-gray-200 sm:translate-x-0 " aria-label="Sidebar">
